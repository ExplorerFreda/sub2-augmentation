...
meta_configs = dotdict.DotDict(
    {
        ...
        'model_name': {
            'values': [
                'xlm-roberta-large', 'bert-large-cased', 'roberta-large'
            ],
...
executor.update_parameters(
    ...
    cpus_per_task=8, gpus_per_node=4, nodes=1, slurm_mem='128G',
...
save_result(result, '../result/sst/attn_finetune.json')
